...
/**
*
* Parcours les enregistrements d'un résultat mysql et les renvoie sous forme de fichier csv
* @param resultat_Mysql $result
*/
function parcoursRs_csv($result, $url){
	if  ($result == false) return array();
	...
	$ligne = $result->fetch();
	fputs($data,  implode(";", array_keys($ligne))."\n");
	fputs($data,  implode(";", array_values($ligne))."\n");
